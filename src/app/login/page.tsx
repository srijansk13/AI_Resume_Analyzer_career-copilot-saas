...
export const metadata = {
  title: 'Log In - Career Copilot',
  description: 'Access the closed-beta premium Career Intelligence OS.',
};
...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#030303] text-slate-100 flex items-stretch relative overflow-hidden">
      ...
      <div className="w-full lg:w-[48%] flex flex-col justify-between p-6 sm:p-10 relative z-10">
        ...
        <div className="my-auto py-8">
          ...
          <p className="mt-8 text-center text-xs font-bold text-gray-500 uppercase tracking-widest">
            ...
            <Link href="/signup" className="text-indigo-400 hover:text-indigo-300 font-extrabold transition-colors">
              Sign up free
            </Link>
          </p>
        </div>
      ...
      {/* Right Column - Visual Graphic Engine Preview */}
      <div className="hidden lg:flex lg:w-[52%] bg-[#06060a]/60 border-l border-white/[0.06] relative p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="space-y-4 max-w-lg relative z-10 pt-16">
          ...
          <h2 className="text-3xl font-black text-white leading-tight">
            Verify credentials to access AI Career Intelligence.
          </h2>
          <p className="text-xs text-gray-400 font-semibold leading-relaxed">
            Our system evaluates formatting structures, margin requirements, double columns, and missing skills to help you build highly compatible resumes.
          </p>
        </div>
