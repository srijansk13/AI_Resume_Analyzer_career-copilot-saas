  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap gap-2.5 z-10">
          <button 
            ...
            className="px-4.5 py-2.5 rounded-xl bg-white hover:bg-slate-200 text-black text-xs font-black shadow-lg shadow-white/5 transition-all flex items-center gap-1.5 hover:scale-[1.02] active:scale-[0.98]"
          >
      ...
      >
        ...
        <div className="group relative p-6 rounded-2xl bg-[#0b0b0f]/60 border border-white/[0.06] backdrop-blur-2xl hover:bg-white/[0.03] hover:border-white/[0.08] transition-all duration-300 shadow-xl">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            {/* Sparkline chart */}
            <svg className="w-20 h-8 text-blue-400/20 group-hover:text-blue-400/40 transition-colors" viewBox="0 0 90 30" fill="none" stroke="currentColor" strokeWidth="2">
              <path d={getSparklineData('resumes')} />
            </svg>
          </div>
          <p className="text-gray-400 text-xs font-bold tracking-wide uppercase">Total Resumes</p>
          <h3 className="text-2xl font-black text-white mt-1.5">{stats.totalResumes}</h3>
          <p className="text-[10px] text-gray-500 mt-1">Unique parsing text hashes</p>
        </div>
        ...
        <div className="group relative p-6 rounded-2xl bg-[#0b0b0f]/60 border border-white/[0.06] backdrop-blur-2xl hover:bg-white/[0.03] hover:border-white/[0.08] transition-all duration-300 shadow-xl">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            {/* Sparkline chart */}
            <svg className="w-20 h-8 text-emerald-400/20 group-hover:text-emerald-400/40 transition-colors" viewBox="0 0 90 30" fill="none" stroke="currentColor" strokeWidth="2">
              <path d={getSparklineData('ats')} />
            </svg>
          </div>
          <p className="text-gray-400 text-xs font-bold tracking-wide uppercase">Average ATS Score</p>
          <h3 className="text-2xl font-black text-white mt-1.5">{stats.avgAtsScore}%</h3>
        ...
        <div className="group relative p-6 rounded-2xl bg-[#0b0b0f]/60 border border-white/[0.06] backdrop-blur-2xl hover:bg-white/[0.03] hover:border-white/[0.08] transition-all duration-300 shadow-xl">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            {/* Sparkline chart */}
            <svg className="w-20 h-8 text-indigo-400/20 group-hover:text-indigo-400/40 transition-colors" viewBox="0 0 90 30" fill="none" stroke="currentColor" strokeWidth="2">
              <path d={getSparklineData('improvements')} />
            </svg>
          </div>
          <p className="text-gray-400 text-xs font-bold tracking-wide uppercase">AI Improvements</p>
          <h3 className="text-2xl font-black text-white mt-1.5">{stats.aiImprovements}</h3>
          <p className="text-[10px] text-gray-500 mt-1">Optimizations generated</p>
        </div>
        ...
        <div className="group relative p-6 rounded-2xl bg-[#0b0b0f]/60 border border-white/[0.06] backdrop-blur-2xl hover:bg-white/[0.03] hover:border-white/[0.08] transition-all duration-300 shadow-xl">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            {/* Sparkline chart */}
            <svg className="w-20 h-8 text-purple-400/20 group-hover:text-purple-400/40 transition-colors" viewBox="0 0 90 30" fill="none" stroke="currentColor" strokeWidth="2">
              <path d={getSparklineData('matches')} />
            </svg>
          </div>
          <p className="text-gray-400 text-xs font-bold tracking-wide uppercase">Job Match Rate</p>
          <h3 className="text-2xl font-black text-white mt-1.5">{stats.matchesFound}%</h3>
          <p className="text-[10px] text-purple-300 mt-1">Simulated profile target match</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="lg:col-span-2 p-6 rounded-2xl bg-white/[0.01] border border-white/[0.03] backdrop-blur-xl space-y-4 flex flex-col justify-between">
          <div>
          ...
          <div className="bg-white/[0.015] border border-white/[0.03] p-4.5 rounded-xl mt-4 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="relative flex items-center justify-center shrink-0">
              <svg className="w-16 h-16 transform -rotate-90">
                <circle cx="32" cy="32" r="28" className="text-white/[0.04]" strokeWidth="3.5" fill="transparent" stroke="currentColor" />
                <circle cx="32" cy="32" r="28" className="text-indigo-500" strokeWidth="3.5" fill="transparent" stroke="currentColor" 
                  strokeDasharray={175} strokeDashoffset={175 - (175 * 78) / 100} strokeLinecap="round" />
              </svg>
              <span className="absolute text-[11px] font-black text-white font-mono">78%</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-white/[0.01] border border-white/[0.03] backdrop-blur-xl relative overflow-hidden flex flex-col justify-between h-[210px]">
          ...
          <div className="p-6 rounded-2xl bg-white/[0.01] border border-white/[0.03] backdrop-blur-xl">
