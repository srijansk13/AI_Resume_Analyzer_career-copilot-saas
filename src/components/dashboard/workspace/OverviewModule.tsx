  ...
  return (
    ...
    >
      <BentoCard className="flex flex-col items-center text-center min-w-0 w-full overflow-hidden bg-[#0a0a0f]/80 border border-white/[0.06] shadow-2xl relative">
        ...
        <h2 className="text-sm font-black uppercase tracking-wider text-gray-300 w-full text-left mb-4 flex items-center justify-between">
        ...
        {!mounted ? (
          <div className="w-full min-w-0 h-[140px] md:h-[180px] animate-pulse rounded-2xl bg-white/5" />
        ) : (
          <div className="w-full min-w-0 h-[140px] md:h-[180px] relative flex items-center justify-center">
            <svg className="w-32 h-32 transform -rotate-90">
              ...
              <circle cx="64" cy="64" r={radius} stroke="rgba(255,255,255,0.03)" strokeWidth={strokeWidth} fill="transparent" />
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-3xl font-black text-white leading-none font-sans tracking-tight">{score}%</span>
